...
function AppSchema(opts) {
    if (!_.String.isUpperCamelCase(opts.name)) {
        throw new E.E_INVALID_APP_NAME({ name: opts.name });
    }
    return reflect_1.default.createClassMetadataDecorator(I.META_APP_OPTIONS, opts);
}
