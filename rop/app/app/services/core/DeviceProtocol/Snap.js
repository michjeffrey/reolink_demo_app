...
let Snap = class Snap {
    constructSnapRequest(args) {
        const body = this._xmlProxy.constructXML({
            'body': {
                'Param004': {
                    'attr001': args.channel,
                    'attr005': args.streamType,
                }
            }
        });
        this._logs.debug({
            'action': 'constructSnapRequest',
            'message': 'ok',
            'data': {
                body
            }
        ...
        return {
            cmd: Command_1.ECommand.NET_SNAP_V30,
            body
        };
    }
};
...
], Snap.prototype, "_logs", void 0);
__decorate([
    DI.Inject(),
    __metadata("design:type", XMLProxy_1.XMLProxy)
], Snap.prototype, "_xmlProxy", void 0);
Snap = __decorate([
    DI.Singleton()
], Snap);
exports.Snap = Snap;
